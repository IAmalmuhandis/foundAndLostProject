    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    <?php $adminData = getAdminByUsername($_SESSION['s_adminUsername']); ?>
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    ...
										    <div class="item-data"><img class="profile-image" src="<?php echo $adminData['avatar']; ?>" alt=""></div>
									    </div><!--//col-->
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data"><?php echo $adminData
											['firstname'] . " " . $adminData['lastname']; ?></div>
									    </div><!--//col-->
									    <div class="col text-end">
										    <a class="btn-sm app-btn-secondary" href="#">Change</a>
									    </div><!--//col-->
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data">shuaibuyahayanka@adverto.com</div>
									    </div><!--//col-->
									    <div class="col text-end">
										    <a class="btn-sm app-btn-secondary" href="#">Change</a>
									    </div><!--//col-->
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data">&#8358;(Nigerian Naira)</div>
									    </div><!--//col-->
									    <div class="col text-end">
										    <a class="btn-sm app-btn-secondary" href="#">Change</a>
									    </div><!--//col-->
